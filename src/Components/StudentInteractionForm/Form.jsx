...
const Form = () => {
  ...
  return (
    <>
    <div style={displays}>Your time has expired</div>
      <div className="container" style={opacity}>
        <div className="d-grid col-md-8 mx-auto my-5">
          <div className="card h-100 border-warning">
            <div
              className="bg-warning d-flex justify-content-between align-items-center"
              style={{ borderBottom: "2px solid #ffc107" }}
            >
              <div></div>
              <h3 className="card-header text-center">Interaction Title</h3>
