                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                                            ...
                                            <table className="table">
                                                <thead>
                                                    <tr className='table-warning'>
                                                        ...
                                                        <th style={display} className='text-center' scope="col">Option 4</th>
                                                        <th style={display} className='text-center' scope="col">Right Option</th>
                                                        <th className='text-center' scope="col">Ideal Answer:</th>
                                                        <th className='text-center' scope="col">Rated?</th>
                                                        <th style={rated} className='text-center' scope="col">ContentRated?</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select onChange={handleOnChange} value={text} className="form-select" id='answer' aria-label="Default select example">
                                                        ...
                                                        <td style={display}>
                                                            <textarea class="form-control" id="idealAnswer" rows="1"></textarea>
                                                        </td>
                                                        <td style={display}>
                                                            <textarea class="form-control" id="idealAnswer" rows="1"></textarea>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <select onChange={handleOnChanges} value={texts} className="form-select" id='rated'>
                                                                <option selected >Select...</option>
                                                                <option >Yes</option>
                                                                <option >No</option>
                                                            </select>
                                                        ...
                                                        <td>
                                                            <select style={rated} className="form-select" id='contentRated'>
                                                                <option selected value="Yes">Select...</option>
                            ...
                            <hr />
                            <div>
                                <button type="submit" className="btn btn-success button me-2" onClick={() => setNoOfRows(noOfRows + 1)} >
                                    Add
                                </button>
                                <button disabled={noOfRows <= 1} type="submit" className="btn btn-danger button" onClick={() => setNoOfRows(noOfRows - 1)} >
                                    Delete
                                </button>
                            </div>
                        </div >
